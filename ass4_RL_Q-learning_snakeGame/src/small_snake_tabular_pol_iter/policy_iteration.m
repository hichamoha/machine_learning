function [values, policy, nbr_pol_iter, nbr_pol_eval] = ...
...
while 1
    ...
    while 1
        ...
        for state_idx = 1 : nbr_states
            ...
            v = values(state_idx);
            nextState = next_state_idxs(state_idx, policy(state_idx));
            ...
            elseif nextState == 0
                ...
                values(state_idx) = (rewards.default + gamm * ...
                                    values(nextState));
            end
            Delta = max(Delta, norm(v - values(state_idx))); 
        end
    ...
    for state_idx = 1 : nbr_states
        ...
        for a = 1 : nbr_actions
            nextState = next_state_idxs(state_idx,a);
            if nextState == -1
                optimalV(a) = rewards.apple + 0;
            elseif nextState == 0
                optimalV(a) = rewards.death + 0;
            else
                optimalV(a) = rewards.default + gamm * values(nextState );
            end
        end
