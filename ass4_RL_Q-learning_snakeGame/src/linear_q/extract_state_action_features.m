function [state_action_feats, prev_grid, prev_head_loc] = ...
    extract_state_action_features(prev_grid, grid, prev_head_loc, nbr_feats)
%
...
%
function [next_head_loc, next_move_dir] = ...
                             get_next_info(action, movement_dir, head_loc)
